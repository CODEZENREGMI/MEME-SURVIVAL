...
| Bezuko | The thug-life demon-girl meme (pixel shades on her head, bamboo in her mouth, tongue out). **AWAKEN** (`Space`, 30 s / 25 s recharge): vines crawl over her, her eyes glow and she bursts into her awakened demon form — horn, vine marks, fangs, 2× size — with 8 hearts, 50% damage resistance, 1.3× speed and 8 HP/s regeneration. The awakening itself burns everything within 110 px. **LMB = EXPLODING BLOOD**: an infinite spray of pink fire (3 × 11 dmg every 0.05 s, pierces once) that sets zombies ablaze. **RMB / Space = DEMON KICK** (1 s): a 120 px dash that boots every zombie in the path for 160 dmg with huge knockback, sets them burning, and dents the haunted house |

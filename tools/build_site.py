...
QA = [
 ...
 ("What characters can I play in Meme Survival?", "characters",
  ...
  "<li><strong>Doge</strong>: radios in an airstrike that carpet-bombs wherever he points, or hauls out a huge machine gun firing incendiary rounds that set zombies on fire.</li>"

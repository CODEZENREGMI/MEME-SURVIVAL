...
QA = [
 ...
 ("What characters can I play in Meme Survival?", "characters",
  ...
  "<li><strong>Doge</strong>: radios in an airstrike that carpet-bombs wherever he points, or hauls out a huge machine gun with unlimited ammo.</li>"
...
UPDATES = [
 ("2026-09-26", [
   "<strong>New survivor: Doge.</strong> Much soldier, very tactical: a Shiba Inu in a plate carrier and the coolest shades on the battlefield. AIRSTRIKE calls in a jet that carpet-bombs wherever he points, and MACHINE GUN hands him a huge minigun with unlimited ammo.",

...
const CHARACTERS = {
  ...
  cry:     { name: 'Cry XD', tag: 'Meme', hp: 100, speed: 1.0, damage: 1.0, firerate: 1.0, reload: 1.0, regen: 0, sprite: 'cry', portrait: 'cry_portrait',
            ...
            desc: 'He is not okay. Never has been. CRY FLOOD (Space): he breaks down and the tears flood the street around him for 10 s — zombies caught in it are slowed to a crawl, swept back by the current and drown, while he keeps shooting. Bosses can wade in, slowly. 28 s recharge.',
            pal: { K: '#16160f', W: '#f2f0e8', w: '#c9c7bd', B: '#2f7fd8', b: '#7ab2ea', M: '#241a18', R: '#8c3a34', C: '#2c3340', c: '#1c222c' },
            cry: { name: 'CRY FLOOD', duration: 10, cooldown: 28, radius: 135, grow: 0.8, drain: 0.7,

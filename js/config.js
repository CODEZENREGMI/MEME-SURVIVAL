...
const CHARACTERS = {
  ...
  frogepepe: { name: 'Frogepepe', tag: 'Transforms · meme', hp: 95, speed: 1.0, damage: 1.0, firerate: 1.0, reload: 1.0, regen: 0, sprite: 'frogepepe', portrait: 'frogepepe_portrait',
            spriteImg: 'assets/img/frogepepe_sprite.png', portraitImg: 'assets/img/frogepepe_portrait.png',   // the Feels Good Man face, redrawn in pixels
  ...
  doge:     { name: 'Doge', tag: 'Meme · soldier', hp: 100, speed: 1.0, damage: 1.0, firerate: 1.0, reload: 1.0, regen: 0, sprite: 'doge', portrait: 'doge',
            ...
            desc: 'Much soldier. Very tactical. Wow. A Shiba Inu in a camo plate carrier and the coolest shades on the battlefield, radio on his shoulder, calm as ever while the city burns. AIRSTRIKE (Space): he radios in a jet on your cursor — a flare marks the spot, and a moment later it carpet-bombs a wide zig-zag of 7 blasts through it, hitting harder every wave. The bombs never hurt him, and he keeps shooting. 25 s recharge. MACHINE GUN (E): he hauls out a huge minigun for 25 s — hold LMB for a stream of incendiary rounds that set every zombie they hit on fire, with unlimited ammo and no reloads. 20 s recharge. (His weapon ability moves to Q; F stays fullscreen.)',
...
const MAPS = {
  ...
  horror:     { name: 'Horror House',    tag: '🩸 NIGHT · HAND-PAINTED', desc: 'A blood-soaked plaza deep in the night — burning wrecks on the corners, cop cars abandoned mid-chase, cold shadows everywhere and only the street lamps still on.', tint: 'rgba(0,0,0,0)',
                size: { w: 110, h: 55 }, image: 'assets/img/horror_map2.webp', menuImage: 'assets/img/horror_menu.webp',   // the whole map is one painted image; the layout below is its collision
                layout: { walk: [[0,9,109,16], [26,7,92,8], [20,0,24,8], [25,0,27,8], [0,17,16,17], [15,17,16,47], [17,16,24,54], [25,16,92,46], [93,9,102,47], [86,0,93,8], [17,47,102,51], [97,52,101,54]],
                    block: [[36,23,40,27], [78,23,81,27], [36,37,40,41], [78,37,81,41], [32,33,33,36], [57,27,58,28], [83,31,84,34], [100,29,101,32], [8,14,9,15], [29,20,30,21], [88,42,89,43], [69,40,73,42], [28,9,33,12], [48,9,53,12], [74,9,78,12], [33,49,35,50], [83,49,85,50], [21,36,26,42], [96,39,104,45], [16,49,19,53], [1,7,2,13], [29,51,34,51], [59,51,64,51], [51,51,55,51]],
                    spawns: [[22,0.5], [22.5,54.5], [0.5,14.5], [109.5,12.5], [89.5,0.5], [26,0.5], [99,54.5]],
                    fires: [[255,95], [1620,650], [292,820]],
                    lamps: [[338,25], [427,268], [1438,268], [1453,25], [425,733], [1455,733]], start: [60,34] } },
};
...
/* Scare spots: places on a map that something jumps out of. A spot with `waves` fires only on those waves, one without
   fires on any wave; either way at most once per wave. Their face and scream are loaded when such a wave starts. */
const SCARE_SPOTS = [
  // Research Lab: a hole torn into the floor of the bench room; something down there looks back
  { id: 'hole', kind: 'hole', map: 'lab', x: 176, y: 424, rx: 22, ry: 15, trigger: 12, waves: [1, 7, 10, 20, 25, 67, 99, 120, 170],

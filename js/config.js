...
const CHARACTERS = {
  ...
  doge:     { name: 'Doge', tag: 'Meme · soldier', hp: 100, speed: 1.0, damage: 1.0, firerate: 1.0, reload: 1.0, regen: 0, sprite: 'doge', portrait: 'doge',
            ...
            mg: { name: 'MACHINE GUN', duration: 25, cooldown: 20, sound: 'assets/audio/doge_mg_loop.wav', interval: 0.045, damage: 16, spread: 0.07, speed: 520, range: 330, kick: 0.8, carry: 0.85 } },
};
